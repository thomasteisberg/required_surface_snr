#!/bin/bash
#
#SBATCH --job-name=cresis_greenland
...
#SBATCH --array=2009-2019
#SBATCH --output=slurm-cresis-gis-%A_%a.out
...
python data_scrapper.py --year=${SLURM_ARRAY_TASK_ID} --dataset Greenland
